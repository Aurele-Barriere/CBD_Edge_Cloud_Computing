...
\begin{frame}
  ...
  \end{block}
  \vfill
  Edge: the devices, small edge servers or existing CDNs (Content Delivery Networks).
  \vfill
   \begin{exampleblock}{Example: Smart Home [SCZ$^+$16]}
...
\begin{frame}
  ...
  \begin{exampleblock}{Indoor 3D localization [LME$^+$15]}
...
\begin{frame}
  ...
  \end{alertblock}
  \vfill
  \begin{exampleblock}{Smart Cities, Smart Homes [BMNZ14]}
...
\begin{frame}
  ...
  \begin{exampleblock}{Online Shopping [LME$^+$15]}
  ...
  \end{exampleblock}
  \vfill
  \begin{exampleblock}{Smart Traffic Light System [BMNZ14]}
...
\begin{frame}
  \frametitle{\secname}
  \framesubtitle{\subsecname: Smart Traffic Light system [BMNZ14]}
...
\begin{frame}
  ...
  \begin{exampleblock}{Video Surveillance [LME$^+$15]}
...
\begin{frame}
  ...
  \begin{exampleblock}{On-demand Gaming [CWSR14]}
